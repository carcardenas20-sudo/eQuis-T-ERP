...
export default function MessageBubble({ message, user }) {
    ...
    return (
        <div className={cn("flex gap-3 my-4", isUser ? "justify-end" : "justify-start")}>
            {!isUser ? (
                <div className="h-8 w-8 rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 flex items-center justify-center text-white mt-0.5 shadow-md">
                    <Zap className="h-4 w-4" />
                </div>
            ) : (
                 <div className="h-8 w-8 rounded-full bg-slate-200 flex items-center justify-center text-slate-600 mt-0.5 shadow-md">
            ...
            <div className={cn("max-w-[85%]", isUser && "flex flex-col items-end")}>
                {message.content && (
                    <div className={cn(
                        ...
                        isUser ? "bg-blue-600 text-white rounded-br-none" : "bg-white border border-slate-200 rounded-bl-none"
                    )}>
                        {isUser ? (
